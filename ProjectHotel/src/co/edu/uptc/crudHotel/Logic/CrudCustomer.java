...
public class CrudCustomer extends AbstractCrud<Customer>{
	...
	protected Customer createInstance() {
		String idCustomerString = JOptionPane.showInputDialog(
	            null,
	            "Digite el número de identificación del cliente : ",
